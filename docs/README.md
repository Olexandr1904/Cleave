...
config-live/
  ...
  projects/
    faria/
      ...
      repos/
        managebac.yaml            # VCS (GitHub), CI, git, architecture, helpers
```
...
- Real config for Faria/ManageBac (eduvo/managebac-mobile-android)
...
- **Jira:** fariaedu.atlassian.net, project MBMOB, trigger label `ai-pipeline`
- **GitHub:** eduvo/managebac-mobile-android
